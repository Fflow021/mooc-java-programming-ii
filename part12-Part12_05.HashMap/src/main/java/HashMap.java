...
public class HashMap<K, V> {
    ...
    //method to copy the old arrayList into another one
    ...
    //method for adding a value do the HashMap
    ...
    //method for removing elements of the map
